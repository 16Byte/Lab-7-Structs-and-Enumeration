/**
 * This program extends Question 1 by using enumerated types for months.
 * It uses structures to store weather data and enums to iterate through months.
 */
...
int main() {
    ...
    cout << "=================================================\n";
    cout << "      Weather Statistics Program - Question 2    \n";
    cout << "=================================================\n\n";
